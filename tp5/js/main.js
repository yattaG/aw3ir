        ...
        methods: {
          ...
          addCity: function (event) {
            ...
            meteo : function (_city){
                ...
                fetch('https://api.openweathermap.org/data/2.5/weather?q='+_city.name+'&units=metric&lang=fr&apikey=355015cc15158ee7281e30902c12fcf7')
                    ...
                    .then(function(json) {
                        ...
                        if(json.cod === 200){
                            ...
                            app.message = null;
                            app.url = 'https://maps.googleapis.com/maps/api/staticmap?markers=' +_city.name +'+LATITTUDE+','+LONGITUDE+'+'&zoom=5&size=400x300&scale=2&key=AIzaSyAkmvI9DazzG9p77IShsz_Di7-5Qn7zkcg';
                        }else{
